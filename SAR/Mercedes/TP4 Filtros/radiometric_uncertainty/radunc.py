...
def get_dict_stats(tif_path, samples_path, samples_col, back_val):
    """
...
def get_dict_ru(dict_samp_stats, p):
    ...
    dict_samp_stats[f'Real. Prob. {p} [%]'] = list_realprob
...
def radunc(tif_path, samples_path, samples_col, list_probs, back_val=0, output='output'):
    ...
    """
    dict_samp_stats = get_dict_stats(tif_path, samples_path, samples_col, back_val=back_val)

    for p in list_probs:
        dict_samp_stats = get_dict_ru(dict_samp_stats, p)
